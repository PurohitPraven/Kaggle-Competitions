...
df_test <- rbind(df_test, predict_oneoff(c("Foundation", "Heating"), df_Foundation))
...
df_Foundation <- predict_oneoff(c("Foundation", "Heating", "BsmtQual", "BsmtCond", "BsmtExposure", "BsmtFinType1", "BsmtFinType2"), df_Foundation)
df_test <- rbind(df_test, subset(df_Foundation, !is.na(SalePrice)))
df_Foundation <- subset(df_Foundation, is.na(SalePrice))

df_Foundation <- predict_oneoff(c("Foundation", "Heating", "BsmtQual", "BsmtCond", "BsmtExposure", "BsmtFinType1", "BsmtFinType2", "GarageType","GarageFinish","log(GarageArea)","GarageQual","GarageCond"), df_Foundation)
df_test <- rbind(df_test, subset(df_Foundation, !is.na(SalePrice)))
df_Foundation <- subset(df_Foundation, is.na(SalePrice))

df_Foundation <- predict_oneoff(c("Foundation", "Heating", "BsmtQual", "BsmtCond", "BsmtExposure", "BsmtFinType1", "BsmtFinType2", "MSZoning", "Functional"), df_Foundation)
df_test <- rbind(df_test, subset(df_Foundation, !is.na(SalePrice)))
df_Foundation <- subset(df_Foundation, is.na(SalePrice))
